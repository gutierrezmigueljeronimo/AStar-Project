...
└── build/                       # Compiled Windows executable (see Releases)
```
...
Built as an individual assignment for the *AI and Big Data* specialisation course at EUSA — Cámara de Comercio de Sevilla (2025).
